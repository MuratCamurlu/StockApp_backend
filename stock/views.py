...
from .serializers import CategorySerializer,CategoryProductSerializer,BrandSerializer,SalesSerializer,FirmSerializer,PurchasesSerializer,ProductSerializer
...
class PurchaseView(viewsets.ModelViewSet):
    ...
    permission_classes = [DjangoModelPermissions]
    filter_backends = [DjangoFilterBackend, filters.SearchFilter]
    filterset_fields = ["firm", "products"]
    search_fields = ["firm"]
